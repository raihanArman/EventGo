...
public class FormLampiranFragment extends Fragment implements ConvertBitmap {
    ...
    FragmentFormLampiranBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_form_lampiran, container, false);
                    ...
                    public void onResponse(Call<Value> call, Response<Value> response) {
                        if(response.isSuccessful()){
                            ...
                            if (response.body().getValue() == 1){
                                String idEvent = response.body().getIdEvent();
                                ...
                                try {
                                    ...
                                    geoFire.setLocation(idEvent, new GeoLocation(latLng.latitude, latLng.longitude), new GeoFire.CompletionListener() {
                                        @Override
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == LAMPIRAN_2_CODE){
            if (resultCode == RESULT_OK && data != null){
                ...
                new LoadBitmapConvertAsync(getActivity(), FormLampiranFragment.this::bitmapToString).execute();
                hasSuratLokasi = true;
            }
            progressDialog.dismiss();
